import{_ as e,o as n,c as i,e as s}from"./app-d417e0ec.js";const d={},a=s(`<h1 id="一-centos-stream-9-安装docker" tabindex="-1"><a class="header-anchor" href="#一-centos-stream-9-安装docker" aria-hidden="true">#</a> 一 centos stream 9 安装docker</h1><h2 id="_1-安装yum-utils" tabindex="-1"><a class="header-anchor" href="#_1-安装yum-utils" aria-hidden="true">#</a> 1 安装yum-utils</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code>yum <span class="token function">install</span> <span class="token parameter variable">-y</span> yum-utils
